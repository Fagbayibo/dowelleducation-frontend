  ...
  return (
    <div className={`w-64 h-screen bg-[#E0F1E5] flex flex-col items-center justify-center relative`}>
      ...
      <ul className="font-bold text-[16px] text-green-900 w-full text-center items-center">
        ...
        <li className="mb-9 mx-3 rounded bg-green-900 shadow-md shadow-green-500/50 hover:bg-white py-2 border border-green-900 group transition duration-300 ease-in-out">
          <a
          ...
          >
            <UserCircleIcon className="h-6 w-6 text-white group-hover:text-green-900 mr-2" />
            User Details
          </a>
        </li>
